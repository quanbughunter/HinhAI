...
kéo nhãn tự do · chụm hai ngón để phóng to · cụm nút thao tác kéo đi được · **bắt dính giao điểm** · đặt tên cả loạt đỉnh và đổi màu / nét · giao diện điện thoại với chat và bảng
phương trình dạng bong bóng thu gọn được · hoàn tác · lưu/mở/xuất PNG ·
273 bài kiểm thử tự động · đóng gói APK tự động bằng GitHub Actions.
