...
export const TOOLS_THAOTAC = [
  { id: 'move', name: 'Chọn / Kéo', icon: ICONS.move, n: 0, hint: 'Kéo đỉnh → hình biến đổi · kéo CHỮ → chỉ dời chữ · kéo cạnh → dời cả hình · bấm đúp để sửa tên và màu · giữ Space (hoặc Ctrl, hoặc chuột giữa) rồi kéo để dời cả bảng.' },
